                ...
                <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay showStatus={false} showThumbs={false} >
                    <div className={classes.image_container} >
                        ...
                        <div className={classes.h1}>
                            <h1 >I'm Navin</h1>
                            <a href="https://docs.google.com/document/d/1sXFUspCXnnnKxQeaEav04-NnCPtE15I6/edit?usp=share_link&ouid=117257003499346922987&rtpof=true&sd=true" rel="opener noreferrer" target="_blank">VIEW CV   <FaArrowCircleDown /></a>
                        </div>
                    </div>
                    <div className={classes.image_container}>
                        ...
                        <div className={classes.h2}>
                            ...
                            <h1>THINGS!!</h1>
                            <a href="https://github.com/DevNavin" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject /></a>
                        </div>
                    </div>
                    {/* <div className={classes.image_container}>
